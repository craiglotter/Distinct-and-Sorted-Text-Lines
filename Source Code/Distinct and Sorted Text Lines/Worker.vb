...
#End Region
    ...
    Private Sub WorkerFileCount_Routine()
        RaiseEvent WorkerStatusMessage("Running Duplicate Line Check", 1)
        ...
        RaiseEvent WorkerStatusMessage("Duplicate Line Check Completed", 1)
        ...
        Try
            ...
            If previousline.Count > 0 Then
                ...
                For Each res As String In previousline
                    ...
                    curr = res
                    If curr <> prev Then
                        filewriter.WriteLine(curr)
                    Else
                        fullcount = fullcount + 1
                        RaiseEvent WorkerFileCount(fullcount, 2)
                        Activity_Logger("Duplicated Item: " & curr)
                    End If
                Next
            Else
                RaiseEvent WorkerFileCount(fullcount, 2)
