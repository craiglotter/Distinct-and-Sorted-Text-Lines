...
Public Class Main_Screen
    ...
    Private force_overwrite As Boolean = False
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.ToolTip1.SetToolTip(Me.txtBaseFolder, "The base folder from which the search is initiated during the Document Line Count" & _
        "er operation")
        '
        'Label3
        '
        ...
        Me.Label3.Text = "BROWSE FOR THE FILE TO BE CHECKED FOR DUPLICATE LINES AND HIT THE PROCESS BUTTON " & _
        ...
        Me.ButtonFolderBrowse.Location = New System.Drawing.Point(264, 48)
        ...
        Me.ToolTip1.SetToolTip(Me.ButtonOperationLaunch, "Launches Distinct and Sorted Text Lines Operation")
        '
        'Button_Pause1
        '
        Me.Button_Pause1.BackColor = System.Drawing.Color.LightSteelBlue
        ...
        Me.ToolTip1.SetToolTip(Me.Button_Pause1, "Pauses Distinct and Sorted Text Lines Operation")
        Me.Button_Pause1.Visible = False
        '
        'Button_ExitThread
        '
        Me.Button_ExitThread.BackColor = System.Drawing.Color.LightSteelBlue
        ...
        Me.ToolTip1.SetToolTip(Me.Button_ExitThread, "Exits Distinct and Sorted Text Lines Operation")
        ...
        Me.Label1.Text = "BUILD 20061122.3"
        ...
        Me.txtStatus.Location = New System.Drawing.Point(40, 224)
        Me.txtStatus.Name = "txtStatus"
        Me.txtStatus.ReadOnly = True
        Me.txtStatus.Size = New System.Drawing.Size(280, 10)
        ...
        'txtFolderCount
        '
        Me.txtFolderCount.BackColor = System.Drawing.Color.Lavender
        ...
        'txtStatusBar1
        '
        Me.txtStatusBar1.BackColor = System.Drawing.Color.Lavender
        ...
        Me.Text = "Distinct and Sorted Text Lines"
...
#End Region
    ...
    Private Sub Error_Handler(ByVal message As String)
        ...
        Catch ex As Exception
            MsgBox("An error occurred in Distinct and Sorted Text Lines's error handling routine. The application will try to recover from this serious error.", MsgBoxStyle.Critical, "Critical Error Encountered")
        End Try
    End Sub
    ...
    Public Sub WorkerFileCountHandler(ByVal Result As Long, ByVal line As Integer)
        Try
            Select Case line
                ...
                Case 2
                    If (Not Worker1.WorkerThread.ThreadState.ToString.IndexOf("Aborted") > -1) And (Not Worker1.WorkerThread.ThreadState.ToString.IndexOf("AbortRequested") > -1) Then
                        SendMessage("txtFileCount2", "Repeated Line Count: " & Result.ToString)
                    End If
                Case 3
                    If (Not Worker1.WorkerThread.ThreadState.ToString.IndexOf("Aborted") > -1) And (Not Worker1.WorkerThread.ThreadState.ToString.IndexOf("AbortRequested") > -1) Then
    ...
    Public Sub WorkerCompleteHandler(ByVal queue As Integer)
        Try
            ...
            If force_exit = True And force_overwrite = True Then
                Try
                    File.Delete(txtBaseFolder.Text)
                    File.Move(txtBaseFolder.Text & "_XTEMPX.txt", txtBaseFolder.Text)
                    Me.Close()
                Catch ex As Exception
                    Error_Handler(ex)
                End Try
            Else
                ...
                If MsgBox("Process Complete. Do you wish to replace your existing text file with the newly created file?", MsgBoxStyle.YesNo, "Process Complete") = MsgBoxResult.Yes Then
                    ...
                    End Try
                Else
                    If MsgBox("Do you wish to keep the temporary file (" & txtBaseFolder.Text & "_XTEMPX.txt" & ") that was generated in the process?", MsgBoxStyle.YesNo, "Process Complete") = MsgBoxResult.No Then
                        Try
                            File.Delete(txtBaseFolder.Text & "_XTEMPX.txt")
                        Catch ex As Exception
                            Error_Handler(ex)
                        End Try
                    End If
    ...
    Private Sub Main_Screen_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Dim inputs As String() = System.Environment.GetCommandLineArgs()
        If inputs.Length > 1 Then

            txtBaseFolder.Text = inputs(1)

          

            If txtBaseFolder.Text.Length > 0 Then
